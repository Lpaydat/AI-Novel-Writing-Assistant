...
export default function NovelBasicInfoForm(props: NovelBasicInfoFormProps) {
  ...
  return (
    <div className="space-y-4">
      <SectionBlock
        title={t("basicInfo.positioningTitle")}
        description={t("basicInfo.positioningDesc")}
        surface="none"
        className="space-y-5"
      >
        ...
        <div className="space-y-2">
          <FieldLabel htmlFor="basic-title">{t("basicInfo.novelTitle")}</FieldLabel>
          <Input
            id="basic-title"
            value={basicForm.title}
            placeholder={t("basicInfo.novelTitlePlaceholder")}
        ...
        <div className="space-y-2">
          <FieldLabel htmlFor="basic-description">{t("basicInfo.oneLineSummary")}</FieldLabel>
          <textarea
            ...
            placeholder={t("basicInfo.oneLineSummaryPlaceholder")}
        ...
        <div className="space-y-2">
          <FieldLabel hint={BASIC_INFO_FIELD_HINTS.writingMode}>{t("basicInfo.writingMode")}</FieldLabel>
        ...
        <div className="space-y-1 pt-1 text-sm leading-6 text-muted-foreground">
          <div className="font-medium text-foreground">{t("basicInfo.genreVsProgressionTitle")}</div>
          <div>
            {t("basicInfo.genreVsProgressionDesc")}
          </div>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          <div className="space-y-2">
            <FieldLabel htmlFor="basic-genre" hint={BASIC_INFO_FIELD_HINTS.genreId}>{t("basicInfo.genreLabel")}</FieldLabel>
            <SelectControl
              id="basic-genre"
            ...
            >
              <option value="">{t("basicInfo.genrePlaceholder")}</option>
          ...
          <div className="space-y-2">
            <FieldLabel htmlFor="basic-default-length" hint={BASIC_INFO_FIELD_HINTS.defaultChapterLength}>
              {t("basicInfo.defaultChapterLength")}
            </FieldLabel>
            <Input
            ...
            />
            <div className="text-xs text-muted-foreground">{t("basicInfo.defaultChapterLengthHint")}</div>
          </div>

          <div className="space-y-2">
            <FieldLabel htmlFor="basic-estimated-chapters" hint={BASIC_INFO_FIELD_HINTS.estimatedChapterCount}>
              {t("basicInfo.estimatedChapterCount")}
            </FieldLabel>
            <Input
            ...
            />
            <div className="text-xs text-muted-foreground">{t("basicInfo.estimatedChapterCountHint")}</div>
          </div>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="space-y-2">
            ...
            >
              <option value="">{t("basicInfo.primaryStoryModePlaceholder")}</option>
          ...
          <div className="space-y-2">
            <FieldLabel htmlFor="basic-secondary-story-mode" hint={BASIC_INFO_FIELD_HINTS.secondaryStoryModeId}>
              {t("basicInfo.secondaryStoryMode")}
            </FieldLabel>
            <SelectControl
            ...
            >
              <option value="">{t("basicInfo.secondaryStoryModePlaceholder")}</option>
              {storyModeOptions.map((storyMode) => (
                <option
                  key={storyMode.id}
                  value={storyMode.id}
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {primaryStoryMode ? (
              <div className="rounded-lg bg-muted/15 p-3">
                <div className="text-sm font-semibold text-foreground">{t("basicInfo.primaryStoryModeSummary")}</div>
                ...
                <div className="mt-2 text-xs text-muted-foreground">{t("basicInfo.coreDriveLine", { drive: primaryStoryMode.profile.coreDrive })}</div>
              </div>
            ) : null}
            {secondaryStoryMode ? (
              <div className="rounded-lg bg-muted/15 p-3">
                <div className="text-sm font-semibold text-foreground">{t("basicInfo.secondaryStoryModeSummary")}</div>
                ...
                <div className="mt-2 text-xs text-muted-foreground">{t("basicInfo.readerRewardLine", { reward: secondaryStoryMode.profile.readerReward })}</div>
              </div>
            ) : null}
          </div>
        ) : null}
      ...
      <details className="group border-t border-border/60 pt-4">
        <summary className="cursor-pointer list-none">
          <CollapsibleSummary
            title={t("basicInfo.advancedTitle")}
            description={t("basicInfo.advancedDesc")}
          />
        </summary>

        <div className="mt-4 space-y-4">
          <div className="space-y-3 pt-1">
            <div className="text-sm font-semibold text-foreground">{t("basicInfo.referenceWorldSample")}</div>
            <div className="mt-1 text-xs leading-5 text-muted-foreground">
              {t("basicInfo.referenceWorldSampleDesc")}
            </div>
            <div className="space-y-2">
              <FieldLabel htmlFor="basic-world" hint={BASIC_INFO_FIELD_HINTS.worldId}>{t("basicInfo.referenceWorldSample")}</FieldLabel>
              <SelectControl
                id="basic-world"
                className="w-full rounded-md border bg-background p-2 text-sm"
              ...
              >
                <option value="">{t("basicInfo.worldPlaceholder")}</option>
          ...
          <SectionBlock
            title={t("basicInfo.narrativeExperienceTitle")}
            description={t("basicInfo.narrativeExperienceDesc")}
            surface="none"
          >
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-pov" hint={BASIC_INFO_FIELD_HINTS.narrativePov}>{t("basicInfo.narrativePov")}</FieldLabel>
                <SelectControl
                  id="basic-pov"
                  className="w-full rounded-md border bg-background p-2 text-sm"
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-pace" hint={BASIC_INFO_FIELD_HINTS.pacePreference}>{t("basicInfo.pacePreference")}</FieldLabel>
                <SelectControl
                  id="basic-pace"
                  className="w-full rounded-md border bg-background p-2 text-sm"
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-emotion" hint={BASIC_INFO_FIELD_HINTS.emotionIntensity}>{t("basicInfo.emotionIntensity")}</FieldLabel>
                <SelectControl
                  id="basic-emotion"
                  className="w-full rounded-md border bg-background p-2 text-sm"
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-style-tone" hint={BASIC_INFO_FIELD_HINTS.styleTone}>{t("basicInfo.styleTone")}</FieldLabel>
                <Input
                  id="basic-style-tone"
                  value={basicForm.styleTone}
                  placeholder={t("basicInfo.styleTonePlaceholder")}
          ...
          <SectionBlock
            title={t("basicInfo.aiCollaborationTitle")}
            description={t("basicInfo.aiCollaborationDesc")}
            surface="none"
          >
            <div className="space-y-2">
              <FieldLabel hint={BASIC_INFO_FIELD_HINTS.projectMode}>{t("basicInfo.projectMode")}</FieldLabel>
              <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-ai-freedom" hint={BASIC_INFO_FIELD_HINTS.aiFreedom}>{t("basicInfo.aiFreedom")}</FieldLabel>
                <SelectControl
                  id="basic-ai-freedom"
                  className="w-full rounded-md border bg-background p-2 text-sm"
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-resource-score" hint={BASIC_INFO_FIELD_HINTS.resourceReadyScore}>
                  {t("basicInfo.resourceReadyScore")}
                </FieldLabel>
                <Input
                ...
                />
                <div className="text-xs text-muted-foreground">{t("basicInfo.resourceReadyScoreHint")}</div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 py-1 sm:flex-row sm:items-start sm:justify-between">
              <div className="space-y-1">
                <FieldLabel htmlFor="basic-post-generation-style-review" hint={BASIC_INFO_FIELD_HINTS.postGenerationStyleReviewEnabled}>
                  {t("basicInfo.postGenStyleReview")}
                </FieldLabel>
                <div className="text-xs leading-5 text-muted-foreground">
                  {t("basicInfo.postGenStyleReviewDesc")}
                </div>
              </div>
              <Switch
                id="basic-post-generation-style-review"
                aria-label={t("basicInfo.postGenStyleReview")}
      ...
      {basicForm.writingMode === "continuation" ? (
        <details className="group border-t border-border/60 pt-4" open>
          <summary className="cursor-pointer list-none">
            <CollapsibleSummary
              title={t("basicInfo.continuationSourceTitle")}
              description={t("basicInfo.continuationSourceDesc")}
              collapsedLabel={t("basicInfo.expandSettings")}
              expandedLabel={t("basicInfo.collapseSettings")}
            />
          </summary>
          <div className="mt-4">
      ...
      <details className="group border-t border-border/60 pt-4">
        <summary className="cursor-pointer list-none">
          <CollapsibleSummary
            title={t("basicInfo.projectStatusTitle")}
            description={t("basicInfo.projectStatusDesc")}
            collapsedLabel={t("basicInfo.expandFields")}
            expandedLabel={t("basicInfo.collapseFields")}
          />
        </summary>
        <div className="mt-4">
          <SectionBlock
            title={t("basicInfo.productionStatusTitle")}
            description={t("basicInfo.productionStatusDesc")}
            surface="none"
          >
            <div className="grid gap-3 md:grid-cols-2">
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-project-status">{t("basicInfo.projectStatus")}</FieldLabel>
                <SelectControl
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-storyline-status">{t("basicInfo.storylineStatus")}</FieldLabel>
                <SelectControl
              ...
              <div className="space-y-2">
                <FieldLabel htmlFor="basic-outline-status">{t("basicInfo.outlineStatus")}</FieldLabel>
                <SelectControl
              ...
              {showPublicationStatus ? (
                <div className="space-y-2">
                  <FieldLabel hint={BASIC_INFO_FIELD_HINTS.status}>{t("basicInfo.publicationStatus")}</FieldLabel>
      ...
      {continuationSourceMissing ? (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-sm text-amber-800">
          {t("basicInfo.continuationSourceMissing")}
        </div>
      ) : null}

      {continuationAnalysisSectionMissing ? (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-sm text-amber-800">
          {t("basicInfo.continuationAnalysisSectionMissing")}
        </div>
      ) : null}
      ...
      <div className="flex justify-end">
        ...
        >
          {isSubmitting ? t("basicInfo.submitting") : submitLabel}
        </Button>
      </div>
    </div>
  );
