        ...
        {selectedPrompt ? (
          <PromptEditorShell
            ...
            bodyPanel={
              <div className="space-y-4">
                <div className="flex flex-col gap-3 rounded-md border border-[#d7e4e0] bg-white/80 p-3 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    <div className="text-sm font-semibold text-[#25443f]">{t("page.editMode")}</div>
                  ...
                  <Tabs value={activeEditMode} onValueChange={(value) => setEditMode(value as PromptEditMode)}>
                    <TabsList className="h-10">
                      <TabsTrigger value="slots" className="px-4">{t("page.slotsMode")}</TabsTrigger>
                      <TabsTrigger
                        value="advanced"
                        className="px-4"
            ...
            runBar={
              <PromptRunBar
                ...
                officialVersionLabel={isAdvancedMode ? t("advanced.restoreOfficialTemplate") : t("runBar.officialVersion")}
                saveLabel={isAdvancedMode ? t("advanced.saveAsNewVersion") : t("runBar.saveOverride")}
          ...
          <div className="flex h-full items-center justify-center p-8">
            <div className="rounded-md border border-dashed bg-background/80 p-6 text-sm text-muted-foreground">
              {t("page.selectPromptPlaceholder")}
            </div>
          </div>
        )}
      </main>
