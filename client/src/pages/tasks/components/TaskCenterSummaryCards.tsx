    ...
    <div className="task-status-summary-grid grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">{t("summary.running")}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">{t("summary.queued")}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">{t("summary.failed")}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-base">{t("summary.completed24h")}</CardTitle>
        </CardHeader>
        <CardContent>
